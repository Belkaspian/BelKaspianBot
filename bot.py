...
- type: одно из TRUCK, TRAILER, UNKNOWN.
  ...
  * Если документ явно указывает легковой автомобиль (SEDAN, PASSENGER) и ваша бизнес‑логика требует отдельного типа — интегатор может расширить типы; по умолчанию для не‑грузовых/не‑прицепных ТС возвращать UNKNOWN.
