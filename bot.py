...
- **Алфавит для plate_number (явно):**
  ...
  * **Не заменять букву 'O' на цифру '0' в plate_number.**
  * Если в plate_number встречаются неоднозначные графемы (O/0, I/1, S/5 и т.п.) и позиционная логика не однозначна — не менять автоматически; ставить needs_human_review = true и добавлять review_reasons "Неоднозначные графемы в plate_number".
...
{ 
  ...
  "driver":{
    "full_name":null,
    "country":null,
    "passport":{"series_number":null,"expiry_date":null,"issuing_authority":null},
